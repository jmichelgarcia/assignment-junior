(function () {
    ...
    app.config(function ($stateProvider, $urlRouterProvider, $controllerProvider) {
        ...
        // you can set this to no template if you just want to use the html in the page
            ...
            .state('pets', {
                url: '/pets',
                templateUrl: viewsPrefix + 'pets.html',
                controller: 'PetListController'
            }).state('viewPet', {
            url: '/pets/:id/view',
            templateUrl: viewsPrefix + 'pet-view.html',
            controller: 'PetViewController'
        }).state('newPet', {
            url: '/pets/new',
            templateUrl: viewsPrefix + 'pet-add.html',
            controller: 'PetCreateController'
        }).state('findPet', {
            url: '/pets/find',
            templateUrl: viewsPrefix + 'pet-find.html',
            controller: 'PetFindController'
        })
    })
